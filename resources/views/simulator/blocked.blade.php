...
<head>
    ...
    <title>Acesso Bloqueado | {{ \App\Models\Setting::get('site_name', 'PayTech') }}</title>
...
<body>
    <div class="card">
        ...
        <p>Seu acesso ao simulador foi <strong>desativado</strong>. Entre em contato com a nossa equipe para reativar.
        </p>
