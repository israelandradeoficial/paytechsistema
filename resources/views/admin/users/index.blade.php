...
@section('content')
    ...
    <script>
        ...
        async function handleAjaxForm(formId, modalId) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            handleAjaxForm('formUserCreate', 'modalUserCreate');
            handleAjaxForm('formUserEdit', 'modalUserEdit');
